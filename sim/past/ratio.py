...
for ratio in [.1, .15, .2, .25, .3, .35, .4, .45]:
	...
	print('Ratio: %.3f; Type 1 error: %.3f' %(ratio, len(P_value[:,0][P_value[:,0] < .05])/len(P_value)))
...
# Ratio: 0.100; Type 1 error: 0.100
# Ratio: 0.100; CASE 1: Power: 0.600
# Ratio: 0.100; CASE 2: Power: 0.800
# Ratio: 0.100; CASE 3: Power: 0.900

# Ratio: 0.150; Type 1 error: 0.000
# Ratio: 0.150; CASE 1: Power: 0.900
# Ratio: 0.150; CASE 2: Power: 1.000
# Ratio: 0.150; CASE 3: Power: 0.900

# Ratio: 0.200; Type 1 error: 0.000
# Ratio: 0.200; CASE 1: Power: 1.000
# Ratio: 0.200; CASE 2: Power: 1.000
# Ratio: 0.200; CASE 3: Power: 1.000

# Ratio: 0.250; Type 1 error: 0.200
# Ratio: 0.250; CASE 1: Power: 1.000
# Ratio: 0.250; CASE 2: Power: 1.000
# Ratio: 0.250; CASE 3: Power: 1.000

# Ratio: 0.300; Type 1 error: 0.100
# Ratio: 0.300; CASE 1: Power: 0.800
# Ratio: 0.300; CASE 2: Power: 1.000
# Ratio: 0.300; CASE 3: Power: 1.000

# Ratio: 0.350; Type 1 error: 0.000
# Ratio: 0.350; CASE 1: Power: 0.500
# Ratio: 0.350; CASE 2: Power: 1.000
# Ratio: 0.350; CASE 3: Power: 1.000
